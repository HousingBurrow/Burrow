/*
  ...
  - You are about to drop the column `updated_at` on the `Listing` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "public"."Listing" DROP COLUMN "created_at",
